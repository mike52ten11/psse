...
### 
    ...
    path('home/download_savefile_of_powerflow_page/', views.download_savefile_of_powerflow_page, name='download_savefile_of_powerflow_page'),
    path('home/download_savefile_of_errorcircuit_page/', views.download_savefile_of_errorcircuit_page, name='download_savefile_of_errorcircuit_page'),
...
### 
    ...
    path('home/download_savefile_of_powerflow/', views.download_savefile_of_powerflow, name='download_savefile_of_powerflow'),
    path('home/download_savefile_of_errorcircuit/', views.download_savefile_of_errorcircuit, name='download_savefile_of_errorcircuit'),

    path('home/sdownload_powerflow/', views.download_powerflow, name='download_powerflow'),
...
### 
    ...
    path('api/area-list-of-api/', views.api_for_get_area_data, name='arealist'),
    path('api/branch-list-of-api/', views.api_for_get_branch_data, name='branchlist'),
    path('api/bus-list-of-api/', views.api_for_get_bus_data, name='buslist'),
    path('api/load-list-of-api/', views.api_for_get_load_data, name='loadlist'),
    path('api/machine-list-of-api/', views.api_for_get_machine_data, name='machinelist'),
    path('api/owner-list-of-api/', views.api_for_get_owner_data, name='ownerlist'),
    path('api/threewinding-list-of-api/', views.api_for_get_threewinding_data, name='threewindinglist'),
    path('api/twowinding-list-of-api/', views.api_for_get_twowinding_data, name='twowindinglist'),
    
    path('api/zone-list-of-api/', views.api_for_get_zone_data, name='zonelist'),
###===================================================
###                   新增sav資料的頁面
###===================================================
### 
...
###===================================================
### 
    path('delete/area/<int:row>/', views.delete_area, name='delete_area'),
    path('edit/area/<int:row>/', views.edit_area, name='edit_area'),


    path('delete/zone/<int:row>/', views.delete_zone, name='delete_zone'),
    path('edit/zone/<int:row>/', views.edit_zone, name='edit_zone'),


    path('delete/owner/<int:row>/', views.delete_owner, name='delete_owner'),
    path('edit/owner/<int:row>/', views.edit_owner, name='edit_owner'),

    path('delete/bus/<int:row>/', views.delete_bus, name='delete_bus'),
    path('edit/bus/<int:row>/', views.edit_bus, name='edit_bus'),


    path('delete/machine/<int:row>/', views.delete_machine, name='delete_machine'),
    path('edit/machine/<int:row>/', views.edit_machine, name='edit_machine'),

    path('delete/load/<int:row>/', views.delete_load, name='delete_load'),
    path('edit/load/<int:row>/', views.edit_load, name='edit_load'),

    path('delete/branch/<int:row>/', views.delete_branch, name='delete_branch'),
    path('edit/branch/<int:row>/', views.edit_branch, name='edit_branch'),
    
    path('delete/twowinding/<int:row>/', views.delete_twowinding, name='delete_twowinding'),
    path('edit/twowinding/<int:row>/', views.edit_twowinding, name='edit_twowinding'),
                  
    path('delete/threewinding/<int:row>/', views.delete_threewinding, name='delete_threewinding'),
    path('edit/threewinding/<int:row>/', views.edit_threewinding, name='edit_threewinding'),

    path('delete/threewinding_winding/<int:row>/', views.delete_threewinding_winding, name='delete_threewinding_winding'),
    path('edit/threewinding_winding/<int:row>/', views.edit_threewinding_winding, name='edit_threewinding_winding'),
