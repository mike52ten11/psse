...
os.makedirs('../Data/User/621615/Dynamic/118P',exist_ok=True)





Source_rawFilename = f"../Data/User/621615/SavFile/118P.sav"
...
psspy.dyre_new([1,1,1,1],f'../Data/User/621615/Dynamic/118P/P-11109.dyr',f"../Data/User/621615/Dynamic/118P/CC2",f"../Data/User/621615/Dynamic/118P/CT2",
f"../Data/User/621615/Dynamic/118P/CP2")
# 匯dll
psspy.addmodellibrary(f'../Data/User/621615/Dynamic/118P/dsusr35.dll')
# 調parameter
...
#建立out檔
psspy.change_channel_out_file(f"../Data/User/621615/Dynamic/118P/118P")
psspy.machine_array_channel([-1,1,221],'1','')
psspy.machine_array_channel([-1,1,532],'2','')
psspy.machine_array_channel([-1,1,1077],'1','')
      
# # initial、Run to 1.0 sec
psspy.strt_2([0,0],f"../Data/User/621615/Dynamic/118P/118P.out")
psspy.run(0, 1.0,5,5,5)
# 對1500進行Bus fault
psspy.dist_3phase_bus_fault(530,0,1,0.0,[0.0,-0.2E+10])
# Run to 1.0667 sec
psspy.change_channel_out_file(f"../Data/User/621615/Dynamic/118P/118P.out")
psspy.run(0, 1.0667,5,5,5)
psspy.dist_branch_trip(530,540,'1')
psspy.dist_branch_trip(530,2170,'1')

# Run to 1.075 sec
psspy.change_channel_out_file(f"../Data/User/621615/Dynamic/118P/118P.out")
psspy.run(0, 1.08333,5,5,5)
# Clear fault
